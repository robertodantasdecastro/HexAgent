 ...
 */
import {
    ArrowDown, Cpu, Hash, Infinity, Pause, Send,
        ...
        <div className="flex-1 overflow-hidden relative flex flex-col h-full">
            ...
            <div className="flex-none p-4 bg-[#0a0a0a] border-t border-[#333] z-30 relative"> 
                <div className="max-w-4xl mx-auto relative group">
                    <div className={`relative flex items-center bg-[#1a1a1a] rounded-lg border ${activeManager.isLoading ? 'border-green-500/30' : 'border-[#333] group-hover:border-gray-600'} transition-all`}>
