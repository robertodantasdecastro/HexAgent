...
class ClaudeStrategy(InferenceStrategy):
    ...
    def get_available_models(self) -> List[str]:
        ...
        Obter modelos disponíveis para Claude/Anthropic
        
        NOTE: Anthropic API does not provide a /models endpoint
        NOTA: API Anthropic não fornece endpoint /models
        
        We maintain a curated static list of known models.
        Mantemos uma lista estática curada de modelos conhecidos.
        
        TODO: Monitor Anthropic API for future model listing capability
        TODO: Monitorar API Anthropic para futura capacidade de listagem
        """
