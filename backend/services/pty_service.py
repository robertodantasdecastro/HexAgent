    ...
    def read_generator(self) -> Generator[str, None, None]:
        ...
        while True:
            ...
            try:
                ...
                # Esperar dados estarem prontos para leitura
                ...
                if self.master_fd in r:
                    ...
                    # No data this loop. Check heartbeat.
                    # Sem dados neste loop. Verificar heartbeat.
                    if time.time() - last_activity > 15.0:
                        yield "" # Heartbeat signal / Sinal de Heartbeat
                        last_activity = time.time()
