...
class SystemController(BaseController):
    ...
    def _get_api_key(self) -> str:
        ...
        try:
            ...
            # 2. Use AI Config Service to get ACTIVE PROFILE key
            # 2. Usa Serviço de Config de IA para obter chave do PERFIL ATIVO
            from services.ai_config_service import AIConfigService
            ai_service = AIConfigService()
            
            # This method already resolves profiles and merges defaults
            # Este método já resolve perfis e mescla padrões
            _, provider_config = ai_service.get_active_provider_config()
